...
//    to get to the parent fields we need to create the constructor manually because @AllArgConstructor does not create a constructor containing the fields of the parent class
